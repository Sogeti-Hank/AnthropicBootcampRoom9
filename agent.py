...
def build_tools() -> List[Dict[str, Any]]:                 # ✏️ Build 1, step 1.3
    ...
    return [
        ...
        },
        {
            ...
            "description": (
                "Find rebookable flights for the disrupted segment on this booking: same "
                "origin, destination, cabin, and passenger count, on the affected date. Use "
                "this after get_flight_status shows a delay or cancellation, to see what "
                "options exist before offering one or calling hold_seat."
            ),
            "input_schema": {
                "type": "object",
